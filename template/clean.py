...
# choose one run
# -------------------------
MODEL_PATH = "/uufs/sci.utah.edu/projects/medvic-lab/Rakib/Time_Series/Time_Series_Forecast/Train_Test_Validation/long_term_forecast_PatchTST_50_100_PatchTST_Single_Phase_Modulation_Clean_70_10_20_0.0001_0.0001_15_Shift_0"   # e.g. Linear Drift Harmonic clean run
OUT_PNG = "clean_real_template_examples.png"
